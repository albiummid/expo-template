 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: Zod types require any for generic schema support
export function useZodForm<TSchema extends z.ZodType<any, any, any>>(
  ...
  return useForm<z.infer<TSchema>>({
    ...options,
    // biome-ignore lint/suspicious/noExplicitAny: Required for zodResolver type compatibility
