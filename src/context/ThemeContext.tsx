...
export const PREMIUM_ACCENT_COLORS: AccentColor[] = [
  ...
  { id: 'slate-purple', name: 'Slate Purple', color: '#7C6BA1', isPremium: true },
...
export const ALL_ACCENT_COLORS = [...FREE_ACCENT_COLORS, ...PREMIUM_ACCENT_COLORS];
...
export function ThemeProvider({ children }: ThemeProviderProps) {
  ...
  const [accentColor, setAccentColor] = useState<AccentColor>(FREE_ACCENT_COLORS[2]); // Default to cyan
